...
def test_filter_usd_transactions(transactions):
    filtered_transactions = filter_by_currency(transactions)
...
def test_filter_rub_transactions(transactions):
    filtered_transactions = filter_by_currency(transactions, "RUB")
    assert next(filtered_transactions) == {
        "id": 873106923,
        "state": "EXECUTED",
        "date": "2019-03-23T01:09:46.296404",
